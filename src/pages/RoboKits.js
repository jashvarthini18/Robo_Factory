...
import './RoboKits.css'; // Adjust the CSS import path as necessary
import ProductDetail from './ProductDetail'; // Import ProductDetail component

const roboKitsProducts = [
  { 
    name: 'Robotics Kit', 
    price: 129, 
    ...
    rating: 4.7,
    category: 'kits',
    description: 'Description of Robotics Kit',
    images: [
        "robotics-main.jpg",
        "robotics-thumb1.jpg",
        "robotics-thumb2.jpg"
  ...
  { 
    ...
    rating: 4.4,
    category: 'robots',
    description: 'Description of DIY Robot Car',
    images: [
        "robotcar-main.jpg",
        "robotcar-thumb1.jpg",
        "robotcar-thumb2.jpg"
...
const RoboKits = () => {
  ...
  // Sorting logic
  const sortedProducts = [...roboKitsProducts].sort((a, b) => {
